...
<head>
    ...
    <style>
        ...
        .btn-suppr {
            background: #e67e22; /* couleur orange pour "Rejeter" */
        }
        .btn-confirm {
            background: #2ecc71;
        }
...
<a href="export_reservations.php" class="btn btn-new-reservation" style="background:#2980b9; color:#fff; padding:8px 15px; border-radius:5px; text-decoration:none;">+ Télécharger Excel des Réservations</a>
...
<form id="searchForm" method="get" action="admin_reservations.php">
    ...
    <input type="date" name="search_date" placeholder="Date (YYYY-MM-DD)" value="<?= htmlspecialchars($searchDate) ?>">
        ...
        data: {
            ...
            datasets: [{
                ...
                backgroundColor: [
                    '#3498db',
                    '#2ecc71',
                    '#e67e22',  // couleur orange pour rejetée
                    '#f1c40f',
                    '#9b59b6'
                ],
                borderColor: '#fff',
